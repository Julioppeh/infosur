    ...
    try {
        ...
        if (!response.ok) {
            ...
            if (contentType.includes('application/json')) {
                ...
                message = sanitizeMessage(errorText) || message;
            }
            message = sanitizeMessage(message) || 'Error al generar el artículo';
        ...
        console.error(error);
        createOutput.textContent = `Error: ${sanitizeMessage(error.message) || 'Se produjo un problema inesperado'}`;
    }
}
